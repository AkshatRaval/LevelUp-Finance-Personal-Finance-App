            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                ...
                <div className="relative col-span-1">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 border border-border rounded-md focus:ring-2 focus:ring-primary focus:border-primary transition"
                    />
                </div>
                ...
                <div className="col-span-1">
                     <select
                        ...
                        className="w-full bg-card border border-border rounded-md py-2 px-3 focus:ring-2 focus:ring-primary focus:border-primary transition"
                    >
